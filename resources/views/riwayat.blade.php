            ...
            <form method="GET" action="/riwayat" class="mb-2">
                <div class="row g-3 align-items-end">
                    <div class="col-md-4 col-sm-6">
                        ...
                        <input type="date" name="tanggal" class="form-control py-2.5" value="{{ $tanggal }}"
                            style="border-radius: 12px; border: 1px solid #e2e8f0;">
                    </div>
                    <div class="col-md-4 col-sm-6 d-flex gap-2">
                        <button type="submit" class="btn btn-primary px-4 py-2.5 fw-semibold"
                            style="border-radius: 12px; background: linear-gradient(135deg, #4f46e5 0%, #4338ca 100%); border: none;">
                            <i class="fa-solid fa-magnifying-glass me-2"></i>Cari
                        </button>
                        @if($tanggal)
                            <a href="/riwayat" class="btn btn-outline-secondary px-4 py-2.5 fw-semibold"
